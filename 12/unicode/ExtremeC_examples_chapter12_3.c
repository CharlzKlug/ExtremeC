...
int main(int argc, char** argv) {
  ...
  char utf8_string_2[32] = u8"لبيذ";

  char16_t utf16_string[32] = u"Hello World!";
  char16_t utf16_string_2[32] = u"لبيذ";
  char16_t utf16_string_3[32] = u"क्द्ज्";

  char32_t utf32_string[32] = U"Hello World!";
  char32_t utf32_string_2[32] = U"لبيذ";
  char32_t utf32_string_3[32] = U"क्द्ज्";
  ...
  printf("Length of UTF-8 Arabic string:\t\t %ld chars, %ld bytes\n",
	 len.num_chars, len.num_bytes);
  len= strlen_u16(utf16_string_2);
  printf("Length of UTF-16 arabic string:\t\t %ld chars, %ld bytes\n",
	 len.num_chars, len.num_bytes);
  len= strlen_u32(utf32_string_2);
  printf("Length of UTF-32 arabic string:\t\t %ld chars, %ld bytes\n\n",
	 len.num_chars, len.num_bytes);
